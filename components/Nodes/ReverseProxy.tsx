...
export type rateLimiterNodeData = Node<{ label: string }, 'reverseProxy'>;

function reverseProxy({ data, selected }: NodeProps<rateLimiterNodeData>) {
    return (
        <div
            className={`
