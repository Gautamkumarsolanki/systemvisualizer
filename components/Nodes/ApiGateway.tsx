...
export type ApiGatewayNodeData = Node<
  {
    label: string;
    title: string;
    handleMetaData: Record<string, ConnectorType>;
  },
  "apigateway"
>;
...
function ApiGatewayNode({
  ...
  return (
    <motion.div
      ...
      ${
        selected
          ? "ring-2 ring-sky-300 border-sky-500 dark:ring-sky-800 dark:border-sky-500"
          : ""
      }
      `}
    >
